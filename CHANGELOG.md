...
- Do not fail if symbolic link to initrd already exists
 ([7f1d4ce](https://github.com/mendersoftware/mender-convert/commit/7f1d4cef840a5349c34e8b561425d17a176a208f))  by @elkoniu

  Part of the conversion script is creation of symbolink link
  to `work/rootfs/boot/initrd`. On some images (Debian minimal cloud image
  or images created with mkosi version 20+) this symlink may already
  exist. We should not treat this as an error.
...
- Bumb mender grub hash
([MEN-8822](https://northerntech.atlassian.net/browse/MEN-8822)) ([b95c2ae](https://github.com/mendersoftware/mender-convert/commit/b95c2aee1673f5dcd62cc7ba9dd83c4c5ca17c83))  by @elkoniu

  Build environment for Grub binary has been updated from Debian 11
  to Debian 12. This results in hash update to use newly created version
  2.12 in mender-convert.
